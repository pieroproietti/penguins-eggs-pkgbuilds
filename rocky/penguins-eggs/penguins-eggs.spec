...
Requires: bash-completion cryptsetup curl device-mapper dosfstools dracut fuse git grub2-efi-x64 grub2-efi-x64-modules grub2-tools-extra jq lvm2 nodejs-devel nvme-cli parted rsync sshfs wget xdg-user-dirs xorriso zstd
...
%%changelog
* Tue Nov 28 2024 Piero Proietti <piero.proietti@gmail.com> - 10.0.54-1rocky9_5
